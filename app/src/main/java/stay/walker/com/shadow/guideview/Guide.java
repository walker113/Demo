package stay.walker.com.shadow.guideview;
...
public class Guide implements View.OnKeyListener, View.OnClickListener {
  ...
  private MaskView onCreateView(Activity activity) {
    ...
    if (mConfiguration.mTargetView != null) {
      KLog.e("目标View坐标 x = " + mConfiguration.mTargetView.getX() + ", y = " + mConfiguration.mTargetView.getY());
      ...
      if (target != null) {
        KLog.e("x = " + target.getX() + ", y = " + target.getY());
    ...
    KLog.e("添加的布局样式文件: " + mComponents.length);
