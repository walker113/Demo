...
public class ShadowLayoutCircle extends FrameLayout {
    ...
    public ShadowLayoutCircle(Context context) {
        super(context);
        initView(context, null);
    }

    public ShadowLayoutCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public ShadowLayoutCircle(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        float x = shadowRect.left + (shadowRect.right - shadowRect.left);
//        float y = shadowRect.top + (shadowRect.bottom - shadowRect.top);
